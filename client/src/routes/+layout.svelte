...
<div class="taskbar95 flex min-w-full p-1">
    <a href="/" class="tb-btn95 flex justify-items-center items-center w-16">
        <img
            alt="website icon"
            class="mr-0.5"
...
<div transition:fade class="max-h-95 bg-95 min-h-95 grid w-full items-center justify-center overflow-scroll">
<slot />
</div>
