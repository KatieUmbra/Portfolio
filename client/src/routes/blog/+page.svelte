...
<!--WRAPPER-->
<div class="border95 bg95-gray max-w-6xl m-3 p-1">
...
<p class=" mt-0.5 text-white">Blog Posts</p> </div>
        ...
        <div class="border95-inv m-1">
            <div class="grid p-2">
                ...
                <div class="flex">
                    ...
                    <p class="txt95 m-1">Created: {element.localTime.toLocaleDateString(undefined, {
                        weekday: "long",
                        year: "numeric",
                        month: "long",
                        day: "numeric"
